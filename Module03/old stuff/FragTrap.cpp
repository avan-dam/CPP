...
/*   Updated: 2020/08/10 11:28:55 by Amber         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap()
{
    ...
    this->_rangedattackdamage = 20;
    this->_armordamagereduction = 5;
    std::cout << "Hocus pocus! " << "New Frag trap exists without a name" << std::endl;
    return ;
}
...
void            FragTrap::rangedAttack(std::string const & target)
{
    ...
    // if (target->_hitpoints > _rangedattackdamage)
        // target->_hitpoints = target->_hitpoints - this->_rangedattackdamage;
...
void        FragTrap::meleeAttack(std::string const & target)
{
    ...
    std::cout << "Total hit points went from "  << this->_hitpoints;
    // if (target->_hitpoints > this->_meleeattackdamage)
    //     target._hitpoints = target._hitpoints - this->_meleeattackdamage;
...
{   
    if (this->_energypoints < this->_maxenergypoints - amount)
    {
    ...
    if (this->_hitpoints < this->_maxhitpoints - amount)
    {
...
void	FragTrap::vaulthunter_dot_exe(std::string const & target)
{
    ...
    // return(name);
        ...
        // elegant your method, the better. 
        // this->_energypoints = this->_energypoints - 25;
    }
}

// // The number of hit points can never exceed the number of max hit points
// // Same forthe energy points. 
// // If, for example, you repair too much HP, then you set them to
